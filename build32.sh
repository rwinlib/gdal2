...
export CFLAGS="-m32 -DNDEBUG -O2 -DLIBXML_STATIC"
export CXXFLAGS="-m32 -DNDEBUG -O2 -DLIBXML_STATIC"
...
./configure \
    ...
    --with-grib \
    --with-pam \
    --with-xml2="/c/msys2-i686/mingw32" \
    --with-cfitsio="/c/msys2-i686/mingw32" \
    --with-libz="/c/msys2-i686/mingw32" \
    --with-liblzma="/c/msys2-i686/mingw32" \
    --with-netcdf="/c/msys2-i686/mingw32" \
    --with-png="/c/msys2-i686/mingw32" \
    --with-jpeg="/c/msys2-i686/mingw32" \
    --with-gif="/c/msys2-i686/mingw32" \
    --with-libtiff="/c/msys2-i686/mingw32" \
    --with-geotiff="/c/msys2-i686/mingw32" \
    --with-spatialite="/c/msys2-i686/mingw32" \
